...
Asistente para el traductor comunitario. **No traduce**: muestra las palabras del material
que están en el *Glosario wichí lhämtes* (con la página del libro) y las que no están, para
que la comunidad las cree o elija. Claude solo elige las palabras importantes del texto en
castellano; lo que aparece en wichí sale siempre del libro.

Auth: docente logueado. Analiza la lectura fácil (o el texto accesible si no hay).
Tarda unos segundos. Sin key o si Claude falla, responde igual en modo básico.

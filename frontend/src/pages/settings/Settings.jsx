...
import { ToggleSwitch } from "../../components/ui/ToggleSwitch"; // Ajusta la ruta si es necesario
import { useSettings } from "../../hooks/useSettings"; // Importamos nuestro hook limpio
import { playSound } from "../../helpers/sounds/audio.js";
import {
  FaSun, FaMoon, FaBell, FaShieldAlt,
  FaAdjust, FaVolumeUp, FaVolumeMute, FaBookReader, FaEnvelope
} from "react-icons/fa";
...
export default function Settings() {
  const {
    ...
    speak
  } = useSettings(); // Destructuramos todo desde el hook

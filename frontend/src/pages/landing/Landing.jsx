        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-start gap-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-forma-teal/30 bg-forma-card text-forma-teal text-xs font-semibold tracking-widest uppercase">
            ...
            <div className="relative w-full max-w-lg mx-auto lg:ml-auto">
              ...
              <button 
                ...
                className="absolute -bottom-6 -right-6 lg:-right-12 w-16 h-16 rounded-2xl border-2 border-white bg-forma-dark hover:bg-forma-card flex items-center justify-center shadow-2xl transition-transform hover:scale-105"
              >
                <FaSearch className="text-2xl text-white" aria-hidden="true" />
              </button>
            </div>
          </div>
        </div>

    ...
    <div className="flex h-screen overflow-hidden font-sans relative bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="absolute bottom-6 right-6 z-50 flex flex-col gap-4">
        <button
          ...
          className="p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all focus:ring-4 focus:ring-blue-300 flex items-center justify-center"
        >
          {isFocusMode ? <FaCompress className="text-xl" /> : <FaExpand className="text-xl" />}
        </button>
      </div>
        ...
        <div className="flex flex-col flex-1 w-full overflow-hidden transition-all duration-300">
          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
              {/* Aquí se renderizan las páginas internas (Settings, Profile, etc.) */}
              <Outlet />
            </div>
          </main>
